<?php
  ...
  define('DIR_FS_DOCUMENT_ROOT', 'C:/wamp/www/osCommerce2/catalog/');
  define('DIR_WS_ADMIN', '/osCommerce2/catalog/admin/');
  define('DIR_FS_ADMIN', 'C:/wamp/www/osCommerce2/catalog/admin/');
  define('DIR_WS_CATALOG', '/osCommerce2/catalog/');
  define('DIR_WS_HTTPS_CATALOG', '/osCommerce2/catalog/');
  define('DIR_FS_CATALOG', 'C:/wamp/www/osCommerce2/catalog/');
